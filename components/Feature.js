    ...
    <FadeIn delay={1500} className="section features">
      <div className="feature-section text-light feature-text">
        ...
        <h2 className="mb-2 pb-2">
          ...
          not. Wait, are you? Is this the oasis?
        </h2>
        <h2 className="mb-2 pb-2">
          You grabbed your <b className="aqua-text">NFTs</b> because they speak
          to you. You
          {` wouldn't `}
          <b className="aqua-text">print</b> them on just anything would you?
          Cool Bored Ape thermo, Dad. See, that sounds lame. What doesn’t sound
          lame is your <b className="aqua-text">NFT</b> on a{" "}
